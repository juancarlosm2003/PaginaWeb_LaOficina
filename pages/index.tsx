            ...
            <div className="row g-5 justify-content-center">
                ...
                >
                  ...
                  <div className="p-4 d-flex flex-column flex-grow-1">
                    ...
                    <p className="card-text text-light">
                      Acompaña tu almuerzo con nuestros jugos refrescantes, el
                      complemento perfecto para tus comidas.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="col-md-4">
                ...
                >
                  ...
                  <div className="p-4 d-flex flex-column flex-grow-1">
                    <h5 className="card-title text-light mb-3">
                      Sopas caseras y deliciosas
                    </h5>
                    <p className="card-text text-light">
                      Sopas frescas y preparadas con ingredientes naturales que
                      reconfortan el alma.
                    </p>
                  </div>
                </div>
              ...
              <div className="col-md-4">
                ...
                >
                  ...
                  <div className="p-4 d-flex flex-column flex-grow-1">
                    ...
                    <p className="card-text text-light">
                      Endulza tu comida con nuestros postres llenos de sabor. El
                      cierre perfecto para tu almuerzo o cena.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="row align-items-center">
              ...
              <div className="col-md-6 text-light">
                ...
                <p className="mb-4" style={{ fontSize: "1.1rem" }}>
                  Disfruta de una gran variedad de platillos caseros con nuestro
                  buffet diario. Fresco, delicioso y perfecto para tus almuerzos
                  en La Oficina.
                </p>
